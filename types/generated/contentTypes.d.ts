...
export interface ApiPatrimonioPatrimonio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    data_entrada: Schema.Attribute.Date;
    descricao: Schema.Attribute.String;
    funcionamento: Schema.Attribute.String;
    id_patrimonio: Schema.Attribute.UID;
    ...
    origem: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    quantidade: Schema.Attribute.String;
    serial: Schema.Attribute.String;
    setor: Schema.Attribute.String;
    tombo: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
